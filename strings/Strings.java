...
public class Strings {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Sem Trim [" + string + "]"); // separado do texto
    System.out.println("Com Trim [" + string.trim() + "]"); // colado no texto
    ...
    System.out.println("Equals? " + string.equals(" Minha String ")); //false pois tem um espaço a menos.
    System.out.println("EqualsIgnoreCase? " + string.equalsIgnoreCase(" minha sTrinG ")); //false pois tem um espaço a menos.
